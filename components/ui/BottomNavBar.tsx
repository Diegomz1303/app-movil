...
// Definimos los tipos de props que recibe este componente
...
export default function BottomNavBar({ activeTab, onTabChange, onAddClick }: BottomNavBarProps) {
  ...
  // Componente interno para cada icono normal
...
const styles = StyleSheet.create({
  ...
  floatingButton: {
    ...
    elevation: 8,
    borderWidth: 4,
    borderColor: COLORES.fondoGris, // Crea el efecto de recorte
  },
});